...
<div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
			...
			<div class="col-md-3 col-lg-3 col-xs-3 col-sm-3">&nbsp;</div>  
			 <div class="col-md-9 col-lg-9 col-xs-9 col-sm-9 disp-dept-cont " id="box">
				    ...
				    <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12">&nbsp;</div>
				        <div class="col-md-9 col-lg-9 col-xs-9 col-sm-9" ng-show="show_test">
							<div class="col-md-12 col-sm-12 col-lg-12 form-group align-input-space font-lato-12-bold">
					        <div class="col-md-1 col-sm-3 col-lg-1 ">&nbsp;</div>
						    ...
						    <div class=" col-sm-7 col-lg-7 col-xs-12 col-md-7" style="height: 100%;margin-top: 10px;" >
							 <input type="radio" name="payment" value="Cash" checked="checked" style="margin-left: -29%;" ng-model="paymentmode" ng-click="click_payment(paymentmode)">Cash
							<input type="radio" name="payment" value="Card" style=" margin-left: 20%;" ng-model="paymentmode" ng-click="click_payment(paymentmode)">Card
							<input type="radio" name="payment" value="Both" style="margin-left: 11%;" ng-model="paymentmode" ng-click="click_paymentmode(paymentmode)"> Devide
										<div ng-show="devide" >
												...
												Card <input type="number" name="card" ng-model="display_pay_details.devidecard" value="{{total2 - display_pay_details.devidecash}}"/> 
	...
	<form class="form-horizontal" name="add_Employee" id="addemployeeform">
	     ...
	     <div class="form-group align-input-space font-lato-12-bold">
			 ...
			 <div class="col-md-12 col-lg-12 col-xs-12 col-sm-12" >
						    ...
						    <label class="control-label col-sm-3 col-lg-3 col-xs-12 col-md-3 align-label lable-add-input" for="name">Payment Mode </label>
						    <div class=" col-sm-9 col-lg-9 col-xs-12 col-md-9" style="height: 100%;margin-top: 10px;" >
								<input type="radio" name="payment1" value="Cash" checked="checked" style="margin-left: -11%;" ng-model="paymentmode" >Cash
								<input type="radio" name="payment1" value="Card" style=" margin-left: 20%;" ng-model="paymentmode" > Card
								<input type="radio" name="payment" value="Both" style="margin-left: 11%;" ng-model="paymentmode" ng-click="click_paymentmodepackage(paymentmode)"> Devide
										<div ng-show="devidepackage">
												Cash <input type="number" name="cash" ng-model="display_pay_details1.devidecash" /> </br>
												Card <input type="number" name="card" ng-model="display_pay_details1.devidecard" value="{{total - display_pay_details1.devidecash}}"/> 
 ...
 <div class=" hidden col-md-12 col-lg-12 col-sm-12 col-xs-12" id="packageprintsection">
	        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"  >
             ...
             <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" style="margin-left:100px"> 	
				...
				<div class="col-md-6 col-sm-6 col-lg-6 col-xs-6" style="width:350px;margin-top:-170px;margin-left:300px;" >
					<table cellpadding="10" >
					    <tr>
							<td >Consulted To : &nbsp;</td>
							<td>{{doctor_name}}</td>
			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12" style="margin-left:100px;">
				<table style="border:1px solid black;width:82%;">
					...
					<tr style="height:20px;" >
						...
						<td style="border-right:1px solid black;padding-left:5px;">{{screen_print.amount}}</td>
					</tr>
					...
					<tr>
						...
						<td style="border-right:1px solid black;padding-left:5px;border-top:1px solid black;">{{screen_print.amount}}</td>
					</tr>
					<tr>
						<td colspan="3" style="border-right:1px solid black;padding-left:5px;text-align:right;padding:2px;">Tax</td>
	 ...
	 <div class=" hidden col-md-12 col-lg-12 col-sm-12 col-xs-12" id="printsection">
	        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"  >
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12" >
						...
						<center><p style="font-size: 20px;">C.V Raman Nagar Post Bangalore-560093</p></center>
						<center><p style="font-size: 20px;">Ph:080 41676336,M:9535566566</p></center>
						<img src="print_barcode.php?barcode_to_print={{screen_print.personal.barcode}}"/>
		  ...
		  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12"> 	
			...
			<div class="col-md-10 col-lg-10 col-sm-10 col-xs-12" style="margin-left:100px;">
				<table style="border:1px solid black;width:82%;">
					...
					<tr style="height:20px;" ng-repeat="test in screen_print.testdata">
						<td style="border-right:1px solid black;padding-left:5px;padding:4px;">{{$index+1}}</td>
					...
					<tr>
						<td colspan="3" style="border-right:1px solid black;padding-left:5px;text-align:right;padding:2px;">Total Amount</td>
						<td style="border-right:1px solid black;padding-left:5px;">{{screen_print.personal.total_sum}}</td>
					</tr>
